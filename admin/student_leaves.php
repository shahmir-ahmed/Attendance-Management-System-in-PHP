...
<head>
    ...
    <title>Student Leaves | Admin Panel | AMS</title>
...
<!-- <div class="header"> -->
    ...
    <a href="student_attendance.php?id=<?php echo $studentID ?>" class="btn btn-dark go-back-btn"><i class="fa-solid fa-angle-left"></i> Attendance</a>
    
    <div class="h1 text-center">Student Leaves</div>

    <!-- <a href="create_report.php?id=<?php echo $studentID ?>" class="btn btn-primary right-btn"><i class="fa-solid fa-file"></i> Create Report</a> -->
<!-- </div> -->
